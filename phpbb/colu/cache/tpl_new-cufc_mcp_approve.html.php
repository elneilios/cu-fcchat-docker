...
<div class="panel">
	...
	<div class="content">
		...
		<?php } if (! $this->_rootref['S_APPROVE']) {  ?>
			...
			<dl class="fields2 nobg">
				<dt><label for="reason"><?php echo ((isset($this->_rootref['L_MORE_INFO'])) ? $this->_rootref['L_MORE_INFO'] : ((isset($user->lang['MORE_INFO'])) ? $user->lang['MORE_INFO'] : '{ MORE_INFO }')); ?>:</label><br /><span><?php echo ((isset($this->_rootref['L_CAN_LEAVE_BLANK'])) ? $this->_rootref['L_CAN_LEAVE_BLANK'] : ((isset($user->lang['CAN_LEAVE_BLANK'])) ? $user->lang['CAN_LEAVE_BLANK'] : '{ CAN_LEAVE_BLANK }')); ?></span></dt>
				<dd><textarea class="inputbox" name="reason" id="reason" rows="4" cols="40"><?php echo (isset($this->_rootref['REASON'])) ? $this->_rootref['REASON'] : ''; ?></textarea></dd>
			</dl>
		<?php } ?>
